...
int main(int argc, char *argv[]) {
	...
	if (bebe){
		...
		scanf("%d",&edad);
		printf("Ingrese el género de la persona\nMasculino = 1\nFemenino = 0\n: ");
		scanf("%d",&genero);
		printf("Ingrese el nivel de Hemoglobina: ");
		scanf("%f",&nivel);
